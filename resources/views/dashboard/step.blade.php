...
<div class='container'>
    <div class='row'>
		<div class='BlockTitle col-lg-6 col-md-6 col-xs-6'>
			<a href="{{ route('dashboard.steps') }}">Steps</a>\ {{$activeStep->name}} &nbsp;
			 <button type='button' class="btn btn-warning" data-toggle="collapse" data-target="#stepEdit">
	...
	<div class='collapse' id="stepEdit">
	<div class='row'>
...
@foreach($components as $component)
 			<div class='row'><a href="{{ route('dashboard.component', $component->id) }}">
	            <div class='col-lg-6 col-md-6 col-xs-6 mb-1'>
					<img class='imageThumbnail mr-1' src='/storage/thumbnails/{{$component->image}}'>&nbsp;{{$component->name}}
				</div></a>
            </div><!-- 
	<div class='row'>
...
@endforeach
    <div class='pt-2'>
		<button type='button' class="btn btn-primary" data-toggle="collapse" data-target="#stepAdd">Add new component</button>
	</div>
